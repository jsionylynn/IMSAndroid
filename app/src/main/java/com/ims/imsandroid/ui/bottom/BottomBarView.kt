package com.ims.imsandroid.ui.bottom
...
import com.ims.imsandroid.utils.BottomItemScreen
...
fun BottomBarView(navController: NavController) {
    val navItem = listOf(
        BottomItemScreen.ORDER,
        BottomItemScreen.GOODS,
        BottomItemScreen.STATISTICS
    )
