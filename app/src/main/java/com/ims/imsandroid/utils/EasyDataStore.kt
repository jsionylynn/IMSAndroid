 ...
 * @author jsiony
 * @date 2022/11/4 17:10
 */
object EasyDataStore {

    // 创建DataStore
    private val IMSApplication.dataStore: DataStore<Preferences> by preferencesDataStore(name = "GoodNews")

    // DataStore变量
    private val dataStore = IMSApplication.instance.dataStore
